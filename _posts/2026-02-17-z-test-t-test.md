---
title: "Statistics for ML #46 — z-test & t-test"
date: 2026-02-17
permalink: /posts/2026/02/z-test-t-test/
tags: [statistics, inference, regression, machine-learning]
---

## z-test & t-test

Post **#46** of 100 in the *Statistics for ML* series by [Md Salek Miah](/) — Statistician, SUST Bangladesh.

### What You Will Learn

The **z-test & t-test** is one of the core building blocks of quantitative research. This post covers:
...
The z-test & t-test formalises how we test hypotheses and make decisions under uncertainty.
...
# z-test & t-test — implementation example
# Full code available at: github.com/muhammadsalek
print("Post #46: z-test & t-test")
...
# Apply z-test & t-test concepts here
print(data.describe())
```
...
cat("Statistics for ML #46: z-test & t-test\n")
...
In my published work on maternal health and mental health outcomes across LMICs, z-test & t-test appears in:

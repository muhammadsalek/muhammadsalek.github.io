---
title: "Statistics for ML #21 — Bernoulli Distribution"
date: 2026-01-21
permalink: /posts/2026/01/bernoulli/
tags: [statistics, probability, distributions, machine-learning]
---

## Bernoulli Distribution

This is post **#21** in the *Statistics for ML* series by **Md Salek Miah**, covering the essential statistical foundations for machine learning and epidemiology research.
...
The **Bernoulli Distribution** is a fundamental concept in probability and statistics. Understanding it deeply enables correct model selection, valid inference, and meaningful interpretation in both classical statistics and modern machine learning.
...
```python
# Template for post #21: Bernoulli Distribution
import numpy as np
import pandas as pd
...
print("Statistics for ML #21: Bernoulli Distribution")
...
# library(tidyverse)
# library(survey)
# Full R code for Bernoulli Distribution
...
*Part of the Statistics for ML series — post #21 of 100.*

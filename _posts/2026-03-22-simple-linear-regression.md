---
title: "Statistics for ML #51 — Simple Linear Regression"
date: 2026-03-22
permalink: /posts/2026/02/simple-linear-regression/
tags: [statistics, inference, regression, machine-learning]
---

## Simple Linear Regression

Post **#51** of 100 in the *Statistics for ML* series by [Md Salek Miah](/) — Statistician, SUST Bangladesh.

### What You Will Learn

The **Simple Linear Regression** is one of the core building blocks of quantitative research. This post covers:
...
The Simple Linear Regression formalises how we model relationships between variables and make predictions.
...
print("Post #51: Simple Linear Regression")
...
# Apply Simple Linear Regression concepts here
print(data.describe())
```
...
cat("Statistics for ML #51: Simple Linear Regression\n")
...
In my published work on maternal health and mental health outcomes across LMICs, Simple Linear Regression appears in:

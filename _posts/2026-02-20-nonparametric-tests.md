---
title: "Statistics for ML #49 — Non-parametric Tests"
date: 2026-02-20
permalink: /posts/2026/02/nonparametric-tests/
tags: [statistics, inference, regression, machine-learning]
---

## Non-parametric Tests

Post **#49** of 100 in the *Statistics for ML* series by [Md Salek Miah](/) — Statistician, SUST Bangladesh.

### What You Will Learn

The **Non-parametric Tests** is one of the core building blocks of quantitative research. This post covers:
...
The Non-parametric Tests formalises how we test hypotheses and make decisions under uncertainty.
...
# Non-parametric Tests — implementation example
# Full code available at: github.com/muhammadsalek
print("Post #49: Non-parametric Tests")
...
# Apply Non-parametric Tests concepts here
print(data.describe())
```
...
cat("Statistics for ML #49: Non-parametric Tests\n")
...
In my published work on maternal health and mental health outcomes across LMICs, Non-parametric Tests appears in:

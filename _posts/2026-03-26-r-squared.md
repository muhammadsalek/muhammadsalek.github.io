---
title: "Statistics for ML #55 — R-squared & Adjusted R-squared"
date: 2026-03-26
permalink: /posts/2026/02/r-squared/
tags: [statistics, inference, regression, machine-learning]
---

## R-squared & Adjusted R-squared

Post **#55** of 100 in the *Statistics for ML* series by [Md Salek Miah](/) — Statistician, SUST Bangladesh.

### What You Will Learn

The **R-squared & Adjusted R-squared** is one of the core building blocks of quantitative research. This post covers:
...
The R-squared & Adjusted R-squared formalises how we model relationships between variables and make predictions.
...
# R-squared & Adjusted R-squared — implementation example
# Full code available at: github.com/muhammadsalek
print("Post #55: R-squared & Adjusted R-squared")
...
# Apply R-squared & Adjusted R-squared concepts here
print(data.describe())
```
...
# R-squared & Adjusted R-squared in R
# Designed for DHS complex survey analysis

cat("Statistics for ML #55: R-squared & Adjusted R-squared\n")
...
In my published work on maternal health and mental health outcomes across LMICs, R-squared & Adjusted R-squared appears in:

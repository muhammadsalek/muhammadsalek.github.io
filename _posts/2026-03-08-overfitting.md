---
title: "Statistics for ML #65 — Overfitting & Underfitting"
date: 2026-03-08
permalink: /posts/2026/02/overfitting/
tags: [statistics, inference, regression, machine-learning]
---

## Overfitting & Underfitting

Post **#65** of 100 in the *Statistics for ML* series by [Md Salek Miah](/) — Statistician, SUST Bangladesh.

### What You Will Learn

The **Overfitting & Underfitting** is one of the core building blocks of quantitative research. This post covers:
...
The Overfitting & Underfitting formalises how we build and evaluate predictive machine learning models.
...
# Overfitting & Underfitting — implementation example
# Full code available at: github.com/muhammadsalek
print("Post #65: Overfitting & Underfitting")
...
# Apply Overfitting & Underfitting concepts here
print(data.describe())
```
...
# Overfitting & Underfitting in R
# Designed for DHS complex survey analysis

cat("Statistics for ML #65: Overfitting & Underfitting\n")
...
In my published work on maternal health and mental health outcomes across LMICs, Overfitting & Underfitting appears in:

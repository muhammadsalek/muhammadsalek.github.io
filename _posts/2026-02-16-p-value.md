---
title: "Statistics for ML #45 — p-value & Statistical Significance"
date: 2026-02-16
permalink: /posts/2026/02/p-value/
tags: [statistics, inference, regression, machine-learning]
---

## p-value & Statistical Significance

Post **#45** of 100 in the *Statistics for ML* series by [Md Salek Miah](/) — Statistician, SUST Bangladesh.

### What You Will Learn

The **p-value & Statistical Significance** is one of the core building blocks of quantitative research. This post covers:
...
The p-value & Statistical Significance formalises how we update beliefs with evidence and test statistical hypotheses.
...
# p-value & Statistical Significance — implementation example
# Full code available at: github.com/muhammadsalek
print("Post #45: p-value & Statistical Significance")
...
# Apply p-value & Statistical Significance concepts here
print(data.describe())
```
...
# p-value & Statistical Significance in R
# Designed for DHS complex survey analysis

cat("Statistics for ML #45: p-value & Statistical Significance\n")
...
In my published work on maternal health and mental health outcomes across LMICs, p-value & Statistical Significance appears in:

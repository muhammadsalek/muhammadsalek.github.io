---
title: "Statistics for ML #61 — Poisson Regression"
date: 2026-03-04
permalink: /posts/2026/02/poisson-regression/
tags: [statistics, inference, regression, machine-learning]
---

## Poisson Regression

Post **#61** of 100 in the *Statistics for ML* series by [Md Salek Miah](/) — Statistician, SUST Bangladesh.

### What You Will Learn

The **Poisson Regression** is one of the core building blocks of quantitative research. This post covers:
...
The Poisson Regression formalises how we build and evaluate predictive machine learning models.
...
# Poisson Regression — implementation example
# Full code available at: github.com/muhammadsalek
print("Post #61: Poisson Regression")
...
# Apply Poisson Regression concepts here
print(data.describe())
```
...
cat("Statistics for ML #61: Poisson Regression\n")
...
In my published work on maternal health and mental health outcomes across LMICs, Poisson Regression appears in:

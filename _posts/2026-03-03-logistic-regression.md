---
title: "Statistics for ML #60 — Logistic Regression & Log-Odds"
date: 2026-03-03
permalink: /posts/2026/02/logistic-regression/
tags: [statistics, inference, regression, machine-learning]
---

## Logistic Regression & Log-Odds

Post **#60** of 100 in the *Statistics for ML* series by [Md Salek Miah](/) — Statistician, SUST Bangladesh.

### What You Will Learn

The **Logistic Regression & Log-Odds** is one of the core building blocks of quantitative research. This post covers:
...
The Logistic Regression & Log-Odds formalises how we model relationships between variables and make predictions.
...
# Logistic Regression & Log-Odds — implementation example
# Full code available at: github.com/muhammadsalek
print("Post #60: Logistic Regression & Log-Odds")
...
# Apply Logistic Regression & Log-Odds concepts here
print(data.describe())
```
...
# Logistic Regression & Log-Odds in R
# Designed for DHS complex survey analysis

cat("Statistics for ML #60: Logistic Regression & Log-Odds\n")
...
In my published work on maternal health and mental health outcomes across LMICs, Logistic Regression & Log-Odds appears in:

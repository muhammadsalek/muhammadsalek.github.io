---
title: "Statistics for ML #38 — Properties of Estimators: Bias, Variance, Consistency"
date: 2026-02-09
permalink: /posts/2026/02/estimator-properties/
tags: [statistics, inference, regression, machine-learning]
---

## Properties of Estimators: Bias, Variance, Consistency

Post **#38** of 100 in the *Statistics for ML* series by [Md Salek Miah](/) — Statistician, SUST Bangladesh.

### What You Will Learn

The **Properties of Estimators: Bias, Variance, Consistency** is one of the core building blocks of quantitative research. This post covers:
...
The Properties of Estimators: Bias, Variance, Consistency formalises how we estimate unknown population parameters from sample data.
...
# Properties of Estimators: Bias, Variance, Consistency — implementation example
# Full code available at: github.com/muhammadsalek
print("Post #38: Properties of Estimators: Bias, Variance, Consistency")
...
# Apply Properties of Estimators: Bias, Variance, Consistency concepts here
print(data.describe())
```
...
# Properties of Estimators: Bias, Variance, Consistency in R
# Designed for DHS complex survey analysis

cat("Statistics for ML #38: Properties of Estimators: Bias, Variance, Consistency\n")
...
In my published work on maternal health and mental health outcomes across LMICs, Properties of Estimators: Bias, Variance, Consistency appears in:
